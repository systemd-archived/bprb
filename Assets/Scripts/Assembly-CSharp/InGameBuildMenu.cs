...
public class InGameBuildMenu : WPFMonoBehaviour
{
	...
	{
		if (data.partType == BasePart.PartType.Egg && data.partType == BasePart.PartType.Egg && !WPFMonoBehaviour.levelManager.CurrentGameMode.ContraptionProto.HasPart(BasePart.PartType.Egg, BasePart.PartTier.Legendary) && WPFMonoBehaviour.levelManager.CurrentGameMode.ContraptionProto.HasAlienGlue)
		{
	...
	{
		if (data.partType == BasePart.PartType.Egg && data.partType == BasePart.PartType.Egg && data.partTier == BasePart.PartTier.Legendary && !WPFMonoBehaviour.levelManager.CurrentGameMode.ContraptionProto.HasSuperGlue)
		{
