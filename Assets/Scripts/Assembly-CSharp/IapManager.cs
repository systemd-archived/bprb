	...
	private void AddBundleItem(BundleItem item)
	{
		switch (item.type)
		{
			...
			case IapManager.BundleItem.BundleItemType.NightVision:
				...
				break;
//			case IapManager.BundleItem.BundleItemType.SuperBluePrint:
//				GameProgress.AddSuperBluePrint(item.count);
//				break;
		}
	}
	...
	private void SendFlurryInventoryGainEvent(BundleItem.BundleItemType type, int amount)
	{
		switch (type)
		{
			...
			case IapManager.BundleItem.BundleItemType.NightVision:
				...
				break;
//			case IapManager.BundleItem.BundleItemType.SuperBluePrint:
//				this.SendFlurryInventoryGainEvent(IapManager.InAppPurchaseItemType.SuperBluePrintSingle, amount, string.Empty);
//				break;
		}
	}
