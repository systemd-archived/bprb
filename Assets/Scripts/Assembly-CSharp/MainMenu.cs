...
public class MainMenu : MonoBehaviour
{
	...
	{
		this.cakeRaceLockScreen.SetActive(false);
	...
	public void LaunchTwitter()
	{
    	if (MainMenu.isGameHallExitOpened)
    	{
   		 ...
   		 Application.OpenURL("https://x.com/AibatAmaznholov");
	}

		public void YouTube_here()
	{
    	if (MainMenu.isGameHallExitOpened)
    	{
        	return;
    	}
   		 Application.OpenURL("https://www.youtube.com/@aibat309boy");
	}

		public void YouTube_here_Gruber()
	{
    	if (MainMenu.isGameHallExitOpened)
    	{
        	return;
    	}
   		 Application.OpenURL("https://www.youtube.com/@gruberlovestoucans");
	}
